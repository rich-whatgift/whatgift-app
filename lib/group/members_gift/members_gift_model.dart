...
import 'members_gift_widget.dart' show MembersGiftWidget;
...
class MembersGiftModel extends FlutterFlowModel<MembersGiftWidget> {
  ...
  // Stores action output result for [Custom Action - getAllGiftsByListID] action in MembersGift widget.
