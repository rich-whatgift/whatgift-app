...
import 'members_gift_model.dart';
export 'members_gift_model.dart';

class MembersGiftWidget extends StatefulWidget {
  const MembersGiftWidget({
    super.key,
  ...
  @override
  State<MembersGiftWidget> createState() => _MembersGiftWidgetState();
}

class _MembersGiftWidgetState extends State<MembersGiftWidget> {
  late MembersGiftModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembersGiftModel());
