...
class _MyListFinalWidgetState extends State<MyListFinalWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.allGiftItemList = widget.giftList!.toList().cast<dynamic>();
      });
    });
  }
                                ...
                                Builder(
                                  builder: (context) {
                                    if (valueOrDefault<bool>(
                                      widget.giftList != null &&
                                          (widget.giftList)!.isNotEmpty,
                                      true,
                                    )) {
                                      return Builder(
                                        builder: (context) {
                                          final allGiftItems =
                                              _model.allGiftItemList.toList();
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemCount: allGiftItems.length,
                                            itemBuilder:
                                                (context, allGiftItemsIndex) {
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return AlertDialog(
                                                                          title:
                                                                              Text('Gift Removed!'),
                                                                          content:
                                                                              Text('The gift has been removed successfully from ${getJsonField(
                                                                            widget.listRow,
                                                                            r'''$.title''',
                                                                          ).toString()}'),
                                                                          actions: [
