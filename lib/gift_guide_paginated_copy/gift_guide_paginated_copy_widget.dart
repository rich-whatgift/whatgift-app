...
import 'gift_guide_paginated_copy_model.dart';
export 'gift_guide_paginated_copy_model.dart';

class GiftGuidePaginatedCopyWidget extends StatefulWidget {
  const GiftGuidePaginatedCopyWidget({super.key});

  @override
  State<GiftGuidePaginatedCopyWidget> createState() =>
      _GiftGuidePaginatedCopyWidgetState();
}

class _GiftGuidePaginatedCopyWidgetState
    extends State<GiftGuidePaginatedCopyWidget> {
  late GiftGuidePaginatedCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GiftGuidePaginatedCopyModel());
