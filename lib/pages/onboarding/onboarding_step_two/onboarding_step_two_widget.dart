...
import 'onboarding_step_two_model.dart';
export 'onboarding_step_two_model.dart';
...
class _OnboardingStepTwoWidgetState extends State<OnboardingStepTwoWidget>
  ...
  late OnboardingStepTwoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingStepTwoModel());
