...
import 'onboarding_step_three_model.dart';
export 'onboarding_step_three_model.dart';
...
class _OnboardingStepThreeWidgetState extends State<OnboardingStepThreeWidget>
  ...
  late OnboardingStepThreeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardingStepThreeModel());
