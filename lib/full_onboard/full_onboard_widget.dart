...
import 'full_onboard_model.dart';
export 'full_onboard_model.dart';

class FullOnboardWidget extends StatefulWidget {
  const FullOnboardWidget({super.key});

  @override
  State<FullOnboardWidget> createState() => _FullOnboardWidgetState();
}

class _FullOnboardWidgetState extends State<FullOnboardWidget>
    with TickerProviderStateMixin {
  late FullOnboardModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FullOnboardModel());
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      8.0),
                                                          child: Text(
                                                            '(Optional) This is simply used if you\'d like receive helpful reminders for upcoming events',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                ...
                                                Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      ...
                                                      if (_model.profilePhotoUploadModel
                                                                  .uploadedLocalFile ==
                                                              null ||
                                                          (_model
                                                                      .profilePhotoUploadModel
