...
import 'filter_list_copy_model.dart';
export 'filter_list_copy_model.dart';

class FilterListCopyWidget extends StatefulWidget {
  const FilterListCopyWidget({super.key});

  @override
  State<FilterListCopyWidget> createState() => _FilterListCopyWidgetState();
}

class _FilterListCopyWidgetState extends State<FilterListCopyWidget> {
  late FilterListCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterListCopyModel());
                                ...
                                child: CheckboxListTile(
                                  ...
                                  onChanged: (newValue) async {
                                    ...
                                    if (newValue!) {
                                      setState(() {
                                        FFAppState()
                                            .addToConditions('gender:Male:eq');
                                      });
                                    } else {
                                      setState(() {
                                ...
                                child: CheckboxListTile(
                                  ...
                                  onChanged: (newValue) async {
                                    ...
                                    if (newValue!) {
                                      setState(() {
                                        FFAppState()
                                            .addToConditions('like_num:50:lte');
                                      });
                                    } else {
                                      setState(() {
                                        FFAppState().removeFromConditions(
                                ...
                                child: CheckboxListTile(
                                  ...
                                  onChanged: (newValue) async {
                                    ...
                                    if (newValue!) {
                                      setState(() {
                                        FFAppState()
                                            .addToConditions('like_num:50:gt');
                                      });
                                    } else {
                                      setState(() {
                                        FFAppState().removeFromConditions(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      _model.filteredGiftGuide =
                        ...
                        query: functions
                            .queryBuilder(FFAppState().conditions.toList()),
                      );
                      setState(() {
