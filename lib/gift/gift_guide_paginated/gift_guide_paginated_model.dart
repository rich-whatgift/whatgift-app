...
class GiftGuidePaginatedModel
    extends FlutterFlowModel<GiftGuidePaginatedWidget> {
  ...
  // Stores action output result for [Custom Action - fetchPaginatedItem] action in GiftGuidePaginated widget.
  List<dynamic>? paginatedData;
  // Stores action output result for [Backend Call - Query Rows] action in GiftGuidePaginated widget.
